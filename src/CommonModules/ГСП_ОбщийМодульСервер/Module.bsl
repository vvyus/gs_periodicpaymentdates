...
Функция ПолучитьСохраненныеНастройки(ДополнительнаяОбработкаСсылка) Экспорт 
	Если ЗначениеЗаполнено(ДополнительнаяОбработкаСсылка) Тогда
		...
		Если СохрНастройки <> Неопределено И ТипЗнч(СохрНастройки)=Тип("ТаблицаЗначений")  Тогда
		 ...
		 КонецЕсли;	  
	Иначе
	// Создаем новую ТаблицуЗначений
		ПустаяТаблица = Новый ТаблицаЗначений;
	// Добавляем колонки
		ПустаяТаблица.Колонки.Добавить("Период", Новый ОписаниеТипов("Дата"));
		ПустаяТаблица.Колонки.Добавить("ПланируемаяДатаВыплатыАванс", Новый ОписаниеТипов("Дата"));
		ПустаяТаблица.Колонки.Добавить("ПланируемаяДатаВыплатыЗарплата", Новый ОписаниеТипов("Дата"));
